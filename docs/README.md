...
This folder is the product, technical, and design specification for Lociros. It describes the running app, not the original six-week plan in `plan.md`.
...
| [Deploy](./deploy.md) | Vercel frontend, Supabase Postgres, FastAPI on any Docker host |
